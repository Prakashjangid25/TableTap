...
export default function MenuImporter({ 
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm animate-fade-in">
      <div className={`w-full max-w-5xl rounded-2xl border shadow-2xl flex flex-col max-h-[90vh] overflow-hidden ${
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div 
                  ...
                  className={`col-span-2 border-2 border-dashed rounded-2xl p-8 text-center cursor-pointer transition-all flex flex-col items-center justify-center min-h-[220px] ${
                    dragActive
                              ...
                              {row.status === 'duplicate' && (
                                <div className="flex flex-col items-center gap-1">
                                  ...
                                  <select
                                    ...
                                    className={`text-[9px] font-semibold border rounded px-1.5 py-0.5 focus:outline-none ${
              ...
              <div className="flex items-center justify-between">
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-semibold cursor-pointer border ${
                    isDark ? 'bg-slate-800 border-slate-700 hover:bg-slate-700 text-slate-300' : 'bg-slate-50 border-slate-200 hover:bg-slate-100'
                  }`}
                >
          ...
          {summary && (
            <div className="py-6 max-w-md mx-auto text-center space-y-6 animate-fade-in">
              ...
              {/* Stats Box */}
              <div className={`p-5 rounded-2xl border text-left space-y-3 font-medium text-xs ${
                isDark ? 'bg-slate-950/40 border-slate-800' : 'bg-slate-50 border-slate-200'
              }`}>
