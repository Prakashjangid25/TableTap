...
export default function ImageUploader({
  ...
  return (
    <div className="space-y-2.5">
      ...
      {value ? (
        /* Image Preview Box */
        <div className={`relative rounded-xl border p-3 flex items-center gap-4 group transition-all ${
            ...
            {uploadMethod === 'upload' && (
              <button
                ...
                className={`p-1.5 rounded-lg border transition-all cursor-pointer hover:scale-105 ${
                  isDark ? 'bg-slate-800 hover:bg-slate-700 border-slate-700 text-slate-300' : 'bg-white hover:bg-slate-100 border-slate-200 text-slate-600'
                }`}
                title="Replace Image"
              >
                <RefreshCw size={13} />
          ...
          {uploadMethod === 'upload' ? (
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-3.5 py-2 text-xs rounded-xl border focus:outline-none focus:border-amber-500 transition-all ${
